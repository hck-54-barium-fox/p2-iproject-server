...
async function getAndSaveData(url, fileName) {
  try {
...
getAndSaveData(" http://store.steampowered.com/api/appdetails?appids=10", "data.json");
...
// ]
// data.forEach(el => {
    // getAndSaveData(`http://store.steampowered.com/api/appdetails?appids=570`, "data.json");
// });